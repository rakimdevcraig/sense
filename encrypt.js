...
//e = credit card num t = credit card cvv
//f_var = encrypted credit p_var = encrypted credit card cvv
function encrypt(e, t, PIE_L, PIE_E, PIE_K, PIE_key_id, PIE_phase) {
    ...
    // console.log('from encrypt file', [f_var, p_var, n.integrity(PIE.K, f_var, p_var)])
    return [f_var, p_var, n.integrity(PIE.K, f_var, p_var)]
}


//format *** everything must be a string
// encrypt("4539616511320249", "329", "6", "4", "6642B6485F5055F8FF98747810F1A898", "82b903f3", "0")
